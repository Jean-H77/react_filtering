    ...
    return(
        <form onSubmit={handleSubmit}>
         <fieldset>
           ...
           <div>
             <input type="radio" id="open" name="status" value="open" onChange={handleInputChange}/>
             <label htmlFor="open">Open</label>
             <input type="radio" id="closed" name="status" value="closed" onChange={handleInputChange}/>
             <label htmlFor="closed">Closed</label>
             <input type="radio" id="both" name="status" value="both" checked onChange={handleInputChange}/>
           ...
           <div>
           <select name="state" id="state" onChange={handleSelectChange} value={formData.state}>
